...
# ╔═╡ cb675211-286e-4a66-a111-5a320ce6a6a3
using PlutoUI, ProgressLogging

# ╔═╡ 1151c2f0-479b-11f1-b637-0ff17faa5e2a
using Plots; Plots.default(size = 500 .* (√2, 1), dpi = 180, linewidth = 2, label = false)

# ╔═╡ fe2a0606-eb5b-49a2-b4c3-10f86bb01298
using UnPack

# ╔═╡ d4ea5512-0fba-4095-b15d-bc92865a8145
using NaNMath

# ╔═╡ bcd37448-2405-45fc-84c7-a34a2931b599
using LaTeXStrings

# ╔═╡ bbd8a408-8523-400e-a112-efa085c436f2
using Optim

# ╔═╡ 9305dabd-82cf-4754-bf80-582e3ab85755
using FastInterpolations

# ╔═╡ 1d6e4863-1a29-446f-837c-386f0416420c
using FastClosures

# ╔═╡ f9bdaead-d373-4831-8130-6f53db765439
using Statistics

# ╔═╡ 49508099-4ed5-4e51-9bf5-fc1c60c30261
using BenchmarkTools

# ╔═╡ 2b159501-3802-413e-92b4-03535dec15e8
html"""
<style>
	main {
		margin: 0 auto;
...
# ╔═╡ 850192cc-88c1-4fb2-86b5-bed78be26d40
TableOfContents()

# ╔═╡ 71d2e4b9-942a-4524-97d4-857fd5d9c5ea
const brent = Optim.Brent();

# ╔═╡ 7ed92891-fb8f-4a1f-8424-3ca70df18094
md"
# Utils
## Optimisation
"

# ╔═╡ a5f6e987-f2a2-45b4-bb27-3d05801ab015
begin
	const ϕ⁻¹ = (√(5.) - 1.) / 2.
	const ϕ⁻² = (3. - √(5.)) / 2.
end;

# ╔═╡ 9ffbc36c-6906-45d7-933a-203cae1e0b46
...
# ╔═╡ 0ee285a0-6493-4723-96f4-3f6ffaf1b809
md"
# Theory

## Microfoundation of Energy Transition Model
"

# ╔═╡ 4d96eb4d-5aee-445a-bbf9-14014dab7657
struct Energy{T}
...
# ╔═╡ f3c71582-bcc7-4eed-be07-f09a72b4450a
struct Cost{T}
...
# ╔═╡ 4540014d-4a24-4816-b1f2-943b51478ac8
"Total costs of installed capacity"
function c(φ, cost::Cost)
    cost.p * φ + cost.κ * φ^2 / 2 
end;

# ╔═╡ 3e42fbcf-27f4-4c7c-b9ff-3eaa468dda9a
md"
## Calibration

- Elasticity ``\gamma =`` $(@bind γ Slider(0:0.01:1, show_value = true, default = 0.446)) 
- Renewable share ``\alpha =`` $(@bind α Slider(0:0.01:1, show_value = true, default = 0.32)) 
"
...
git-tree-sha1 = "b3a5125f85ad34c115068ef80cd0bb06e338211b"
...
git-tree-sha1 = "693e6a9c238b1e1991c2c8488b5cfc46d265b864"
